...
// import workerSrc from "pdfjs-dist/build/pdf.worker.min.js"; // 🔑 same version
...
//         setPdfBase64(`data:application/pdf;base64,${pdfData.base64}`);
//       }
//     } catch (err) {
...
//             }}
//           >
//             {JSON.stringify(result.cleanedJson, null, 2)}
//           </pre>
//         </div>
//       )}
...
//       // Fetch the PDF base64 from backend
//       const pdfRes = await fetch(`${API_URL}/documents/${data.data.id}/pdf`);
//       const pdfData = await pdfRes.json();

//       if (pdfData.base64) {
//         // Convert base64 → Blob URL for Viewer
